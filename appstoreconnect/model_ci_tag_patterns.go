...
// checks if the CiTagPatterns type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CiTagPatterns{}

// CiTagPatterns struct for CiTagPatterns
...
func (o CiTagPatterns) MarshalJSON() ([]byte, error) {
...
func (o CiTagPatterns) ToMap() (map[string]interface{}, error) {
...
type NullableCiTagPatterns struct {
	value *CiTagPatterns
	isSet bool
}

func (v NullableCiTagPatterns) Get() *CiTagPatterns {
	return v.value
}

func (v *NullableCiTagPatterns) Set(val *CiTagPatterns) {
	v.value = val
	v.isSet = true
}

func (v NullableCiTagPatterns) IsSet() bool {
	return v.isSet
}

func (v *NullableCiTagPatterns) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCiTagPatterns(val *CiTagPatterns) *NullableCiTagPatterns {
	return &NullableCiTagPatterns{value: val, isSet: true}
}

func (v NullableCiTagPatterns) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCiTagPatterns) UnmarshalJSON(src []byte) error {
	v.isSet = true
