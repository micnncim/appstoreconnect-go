...
// checks if the DeviceUpdateRequestDataAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceUpdateRequestDataAttributes{}
...
func (o DeviceUpdateRequestDataAttributes) ToMap() (map[string]interface{}, error) {
