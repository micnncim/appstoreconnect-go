...
// checks if the AppCustomProductPageVersionResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppCustomProductPageVersionResponse{}

// AppCustomProductPageVersionResponse struct for AppCustomProductPageVersionResponse
...
func NewAppCustomProductPageVersionResponse(data AppCustomProductPageVersion, links DocumentLinks) *AppCustomProductPageVersionResponse {
	this := AppCustomProductPageVersionResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o AppCustomProductPageVersionResponse) MarshalJSON() ([]byte, error) {
...
func (o AppCustomProductPageVersionResponse) ToMap() (map[string]interface{}, error) {
...
type NullableAppCustomProductPageVersionResponse struct {
	value *AppCustomProductPageVersionResponse
	isSet bool
}

func (v NullableAppCustomProductPageVersionResponse) Get() *AppCustomProductPageVersionResponse {
	return v.value
}

func (v *NullableAppCustomProductPageVersionResponse) Set(val *AppCustomProductPageVersionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppCustomProductPageVersionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppCustomProductPageVersionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppCustomProductPageVersionResponse(val *AppCustomProductPageVersionResponse) *NullableAppCustomProductPageVersionResponse {
	return &NullableAppCustomProductPageVersionResponse{value: val, isSet: true}
}

func (v NullableAppCustomProductPageVersionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppCustomProductPageVersionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
