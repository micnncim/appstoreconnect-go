...
// checks if the BetaLicenseAgreementsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BetaLicenseAgreementsResponse{}
...
func (o BetaLicenseAgreementsResponse) ToMap() (map[string]interface{}, error) {
