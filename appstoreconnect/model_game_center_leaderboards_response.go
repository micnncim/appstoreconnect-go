...
// checks if the GameCenterLeaderboardsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GameCenterLeaderboardsResponse{}

// GameCenterLeaderboardsResponse struct for GameCenterLeaderboardsResponse
...
func NewGameCenterLeaderboardsResponse(data []GameCenterLeaderboard, links PagedDocumentLinks) *GameCenterLeaderboardsResponse {
	this := GameCenterLeaderboardsResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o GameCenterLeaderboardsResponse) MarshalJSON() ([]byte, error) {
...
func (o GameCenterLeaderboardsResponse) ToMap() (map[string]interface{}, error) {
...
type NullableGameCenterLeaderboardsResponse struct {
	value *GameCenterLeaderboardsResponse
	isSet bool
}

func (v NullableGameCenterLeaderboardsResponse) Get() *GameCenterLeaderboardsResponse {
	return v.value
}

func (v *NullableGameCenterLeaderboardsResponse) Set(val *GameCenterLeaderboardsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGameCenterLeaderboardsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGameCenterLeaderboardsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGameCenterLeaderboardsResponse(val *GameCenterLeaderboardsResponse) *NullableGameCenterLeaderboardsResponse {
	return &NullableGameCenterLeaderboardsResponse{value: val, isSet: true}
}

func (v NullableGameCenterLeaderboardsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGameCenterLeaderboardsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
