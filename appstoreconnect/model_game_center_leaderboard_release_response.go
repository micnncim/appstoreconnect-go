...
// checks if the GameCenterLeaderboardReleaseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GameCenterLeaderboardReleaseResponse{}

// GameCenterLeaderboardReleaseResponse struct for GameCenterLeaderboardReleaseResponse
...
func NewGameCenterLeaderboardReleaseResponse(data GameCenterLeaderboardRelease, links DocumentLinks) *GameCenterLeaderboardReleaseResponse {
	this := GameCenterLeaderboardReleaseResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o GameCenterLeaderboardReleaseResponse) MarshalJSON() ([]byte, error) {
...
func (o GameCenterLeaderboardReleaseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableGameCenterLeaderboardReleaseResponse struct {
	value *GameCenterLeaderboardReleaseResponse
	isSet bool
}

func (v NullableGameCenterLeaderboardReleaseResponse) Get() *GameCenterLeaderboardReleaseResponse {
	return v.value
}

func (v *NullableGameCenterLeaderboardReleaseResponse) Set(val *GameCenterLeaderboardReleaseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGameCenterLeaderboardReleaseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGameCenterLeaderboardReleaseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGameCenterLeaderboardReleaseResponse(val *GameCenterLeaderboardReleaseResponse) *NullableGameCenterLeaderboardReleaseResponse {
	return &NullableGameCenterLeaderboardReleaseResponse{value: val, isSet: true}
}

func (v NullableGameCenterLeaderboardReleaseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGameCenterLeaderboardReleaseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
