...
// checks if the UserInvitationRelationships type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserInvitationRelationships{}
...
func (o UserInvitationRelationships) ToMap() (map[string]interface{}, error) {
