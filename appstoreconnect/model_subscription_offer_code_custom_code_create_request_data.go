...
// checks if the SubscriptionOfferCodeCustomCodeCreateRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionOfferCodeCustomCodeCreateRequestData{}

// SubscriptionOfferCodeCustomCodeCreateRequestData struct for SubscriptionOfferCodeCustomCodeCreateRequestData
type SubscriptionOfferCodeCustomCodeCreateRequestData struct {
	Type          string                                                        `json:"type"`
	Attributes    SubscriptionOfferCodeCustomCodeCreateRequestDataAttributes    `json:"attributes"`
...
func NewSubscriptionOfferCodeCustomCodeCreateRequestData(type_ string, attributes SubscriptionOfferCodeCustomCodeCreateRequestDataAttributes, relationships SubscriptionOfferCodeCustomCodeCreateRequestDataRelationships) *SubscriptionOfferCodeCustomCodeCreateRequestData {
	this := SubscriptionOfferCodeCustomCodeCreateRequestData{}
	this.Type = type_
...
func (o *SubscriptionOfferCodeCustomCodeCreateRequestData) GetAttributes() SubscriptionOfferCodeCustomCodeCreateRequestDataAttributes {
	if o == nil {
		var ret SubscriptionOfferCodeCustomCodeCreateRequestDataAttributes
		return ret
	}
...
func (o SubscriptionOfferCodeCustomCodeCreateRequestData) MarshalJSON() ([]byte, error) {
...
func (o SubscriptionOfferCodeCustomCodeCreateRequestData) ToMap() (map[string]interface{}, error) {
...
type NullableSubscriptionOfferCodeCustomCodeCreateRequestData struct {
	value *SubscriptionOfferCodeCustomCodeCreateRequestData
	isSet bool
}

func (v NullableSubscriptionOfferCodeCustomCodeCreateRequestData) Get() *SubscriptionOfferCodeCustomCodeCreateRequestData {
	return v.value
}

func (v *NullableSubscriptionOfferCodeCustomCodeCreateRequestData) Set(val *SubscriptionOfferCodeCustomCodeCreateRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullableSubscriptionOfferCodeCustomCodeCreateRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullableSubscriptionOfferCodeCustomCodeCreateRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubscriptionOfferCodeCustomCodeCreateRequestData(val *SubscriptionOfferCodeCustomCodeCreateRequestData) *NullableSubscriptionOfferCodeCustomCodeCreateRequestData {
	return &NullableSubscriptionOfferCodeCustomCodeCreateRequestData{value: val, isSet: true}
}

func (v NullableSubscriptionOfferCodeCustomCodeCreateRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubscriptionOfferCodeCustomCodeCreateRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
