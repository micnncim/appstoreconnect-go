...
// checks if the AppStoreReviewAttachmentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppStoreReviewAttachmentResponse{}
...
func (o AppStoreReviewAttachmentResponse) ToMap() (map[string]interface{}, error) {
