...
type AppRelationships struct {
	...
	AppStoreVersions          *AppStoreVersionExperimentV2RelationshipsControlVersions `json:"appStoreVersions,omitempty"`
...
// SetAppStoreVersions gets a reference to the given AppStoreVersionExperimentV2RelationshipsControlVersions and assigns it to the AppStoreVersions field.
