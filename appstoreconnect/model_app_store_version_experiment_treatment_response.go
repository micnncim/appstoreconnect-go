...
// checks if the AppStoreVersionExperimentTreatmentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppStoreVersionExperimentTreatmentResponse{}

// AppStoreVersionExperimentTreatmentResponse struct for AppStoreVersionExperimentTreatmentResponse
...
func NewAppStoreVersionExperimentTreatmentResponse(data AppStoreVersionExperimentTreatment, links DocumentLinks) *AppStoreVersionExperimentTreatmentResponse {
	this := AppStoreVersionExperimentTreatmentResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o AppStoreVersionExperimentTreatmentResponse) MarshalJSON() ([]byte, error) {
...
func (o AppStoreVersionExperimentTreatmentResponse) ToMap() (map[string]interface{}, error) {
...
type NullableAppStoreVersionExperimentTreatmentResponse struct {
	value *AppStoreVersionExperimentTreatmentResponse
	isSet bool
}

func (v NullableAppStoreVersionExperimentTreatmentResponse) Get() *AppStoreVersionExperimentTreatmentResponse {
	return v.value
}

func (v *NullableAppStoreVersionExperimentTreatmentResponse) Set(val *AppStoreVersionExperimentTreatmentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppStoreVersionExperimentTreatmentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppStoreVersionExperimentTreatmentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppStoreVersionExperimentTreatmentResponse(val *AppStoreVersionExperimentTreatmentResponse) *NullableAppStoreVersionExperimentTreatmentResponse {
	return &NullableAppStoreVersionExperimentTreatmentResponse{value: val, isSet: true}
}

func (v NullableAppStoreVersionExperimentTreatmentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppStoreVersionExperimentTreatmentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
