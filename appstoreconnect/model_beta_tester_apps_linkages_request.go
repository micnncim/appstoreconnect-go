...
func NewBetaTesterAppsLinkagesRequest(data []AppAvailabilityV2CreateRequestDataRelationshipsAppData) *BetaTesterAppsLinkagesRequest {
...
func (o *BetaTesterAppsLinkagesRequest) GetData() []AppAvailabilityV2CreateRequestDataRelationshipsAppData {
	if o == nil {
...
func (o *BetaTesterAppsLinkagesRequest) GetDataOk() ([]AppAvailabilityV2CreateRequestDataRelationshipsAppData, bool) {
	if o == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *BetaTesterAppsLinkagesRequest) SetData(v []AppAvailabilityV2CreateRequestDataRelationshipsAppData) {
	o.Data = v
}
