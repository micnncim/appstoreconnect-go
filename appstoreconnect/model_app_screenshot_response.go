...
// checks if the AppScreenshotResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppScreenshotResponse{}
...
func (o AppScreenshotResponse) ToMap() (map[string]interface{}, error) {
