...
const (
	GAMECENTERLEADERBOARDFORMATTER_INTEGER                  GameCenterLeaderboardFormatter = "INTEGER"
	GAMECENTERLEADERBOARDFORMATTER_DECIMAL_POINT_1_PLACE    GameCenterLeaderboardFormatter = "DECIMAL_POINT_1_PLACE"
	GAMECENTERLEADERBOARDFORMATTER_DECIMAL_POINT_2_PLACE    GameCenterLeaderboardFormatter = "DECIMAL_POINT_2_PLACE"
	GAMECENTERLEADERBOARDFORMATTER_DECIMAL_POINT_3_PLACE    GameCenterLeaderboardFormatter = "DECIMAL_POINT_3_PLACE"
	GAMECENTERLEADERBOARDFORMATTER_ELAPSED_TIME_MILLISECOND GameCenterLeaderboardFormatter = "ELAPSED_TIME_MILLISECOND"
	GAMECENTERLEADERBOARDFORMATTER_ELAPSED_TIME_MINUTE      GameCenterLeaderboardFormatter = "ELAPSED_TIME_MINUTE"
	GAMECENTERLEADERBOARDFORMATTER_ELAPSED_TIME_SECOND      GameCenterLeaderboardFormatter = "ELAPSED_TIME_SECOND"
	GAMECENTERLEADERBOARDFORMATTER_MONEY_POUND_DECIMAL      GameCenterLeaderboardFormatter = "MONEY_POUND_DECIMAL"
	GAMECENTERLEADERBOARDFORMATTER_MONEY_POUND              GameCenterLeaderboardFormatter = "MONEY_POUND"
	GAMECENTERLEADERBOARDFORMATTER_MONEY_DOLLAR_DECIMAL     GameCenterLeaderboardFormatter = "MONEY_DOLLAR_DECIMAL"
	GAMECENTERLEADERBOARDFORMATTER_MONEY_DOLLAR             GameCenterLeaderboardFormatter = "MONEY_DOLLAR"
	GAMECENTERLEADERBOARDFORMATTER_MONEY_EURO_DECIMAL       GameCenterLeaderboardFormatter = "MONEY_EURO_DECIMAL"
	GAMECENTERLEADERBOARDFORMATTER_MONEY_EURO               GameCenterLeaderboardFormatter = "MONEY_EURO"
	GAMECENTERLEADERBOARDFORMATTER_MONEY_FRANC_DECIMAL      GameCenterLeaderboardFormatter = "MONEY_FRANC_DECIMAL"
	GAMECENTERLEADERBOARDFORMATTER_MONEY_FRANC              GameCenterLeaderboardFormatter = "MONEY_FRANC"
	GAMECENTERLEADERBOARDFORMATTER_MONEY_KRONER_DECIMAL     GameCenterLeaderboardFormatter = "MONEY_KRONER_DECIMAL"
	GAMECENTERLEADERBOARDFORMATTER_MONEY_KRONER             GameCenterLeaderboardFormatter = "MONEY_KRONER"
	GAMECENTERLEADERBOARDFORMATTER_MONEY_YEN                GameCenterLeaderboardFormatter = "MONEY_YEN"
)
