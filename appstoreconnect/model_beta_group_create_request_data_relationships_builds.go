...
// checks if the BetaGroupCreateRequestDataRelationshipsBuilds type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BetaGroupCreateRequestDataRelationshipsBuilds{}
...
func (o BetaGroupCreateRequestDataRelationshipsBuilds) ToMap() (map[string]interface{}, error) {
