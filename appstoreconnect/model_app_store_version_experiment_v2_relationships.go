...
type AppStoreVersionExperimentV2Relationships struct {
	...
	LatestControlVersion                *AppClipDefaultExperienceRelationshipsReleaseWithAppStoreVersion             `json:"latestControlVersion,omitempty"`
...
// SetLatestControlVersion gets a reference to the given AppClipDefaultExperienceRelationshipsReleaseWithAppStoreVersion and assigns it to the LatestControlVersion field.
