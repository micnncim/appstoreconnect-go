...
// checks if the AppRelationshipsBuilds type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppRelationshipsBuilds{}
...
func (o AppRelationshipsBuilds) ToMap() (map[string]interface{}, error) {
