...
func (r ApiDiagnosticSignaturesLogsGetToManyRelatedRequest) Execute() (*DiagnosticLogs, *http.Response, error) {
...
*/
func (a *DiagnosticSignaturesApiService) DiagnosticSignaturesLogsGetToManyRelated(ctx context.Context, id string) ApiDiagnosticSignaturesLogsGetToManyRelatedRequest {
	return ApiDiagnosticSignaturesLogsGetToManyRelatedRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
func (a *DiagnosticSignaturesApiService) DiagnosticSignaturesLogsGetToManyRelatedExecute(r ApiDiagnosticSignaturesLogsGetToManyRelatedRequest) (*DiagnosticLogs, *http.Response, error) {
	var (
	...
	localVarHTTPHeaderAccepts := []string{"application/json", "application/vnd.apple.diagnostic-logs+json"}
