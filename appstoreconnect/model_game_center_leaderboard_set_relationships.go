...
type GameCenterLeaderboardSetRelationships struct {
	...
	GroupLeaderboardSet    *GameCenterLeaderboardSetLocalizationRelationshipsGameCenterLeaderboardSet `json:"groupLeaderboardSet,omitempty"`
...
func (o *GameCenterLeaderboardSetRelationships) GetGameCenterDetailOk() (*AppRelationshipsGameCenterDetail, bool) {
	if o == nil || IsNil(o.GameCenterDetail) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *GameCenterLeaderboardSetRelationships) GetGroupLeaderboardSetOk() (*GameCenterLeaderboardSetLocalizationRelationshipsGameCenterLeaderboardSet, bool) {
	if o == nil || IsNil(o.GroupLeaderboardSet) {
		return nil, false
	}
...
// SetGroupLeaderboardSet gets a reference to the given GameCenterLeaderboardSetLocalizationRelationshipsGameCenterLeaderboardSet and assigns it to the GroupLeaderboardSet field.
