...
type GameCenterDetailUpdateRequestDataRelationships struct {
	...
	DefaultLeaderboard      *GameCenterDetailUpdateRequestDataRelationshipsDefaultLeaderboard   `json:"defaultLeaderboard,omitempty"`
	DefaultGroupLeaderboard *GameCenterDetailUpdateRequestDataRelationshipsDefaultLeaderboard   `json:"defaultGroupLeaderboard,omitempty"`
}
...
func (o *GameCenterDetailUpdateRequestDataRelationships) GetDefaultLeaderboard() GameCenterDetailUpdateRequestDataRelationshipsDefaultLeaderboard {
	if o == nil || IsNil(o.DefaultLeaderboard) {
		var ret GameCenterDetailUpdateRequestDataRelationshipsDefaultLeaderboard
		return ret
	}
...
// SetDefaultLeaderboard gets a reference to the given GameCenterDetailUpdateRequestDataRelationshipsDefaultLeaderboard and assigns it to the DefaultLeaderboard field.
...
// SetDefaultGroupLeaderboard gets a reference to the given GameCenterDetailUpdateRequestDataRelationshipsDefaultLeaderboard and assigns it to the DefaultGroupLeaderboard field.
