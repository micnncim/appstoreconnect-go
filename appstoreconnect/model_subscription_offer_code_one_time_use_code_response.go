...
// checks if the SubscriptionOfferCodeOneTimeUseCodeResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionOfferCodeOneTimeUseCodeResponse{}

// SubscriptionOfferCodeOneTimeUseCodeResponse struct for SubscriptionOfferCodeOneTimeUseCodeResponse
type SubscriptionOfferCodeOneTimeUseCodeResponse struct {
...
func NewSubscriptionOfferCodeOneTimeUseCodeResponse(data SubscriptionOfferCodeOneTimeUseCode, links DocumentLinks) *SubscriptionOfferCodeOneTimeUseCodeResponse {
	this := SubscriptionOfferCodeOneTimeUseCodeResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o SubscriptionOfferCodeOneTimeUseCodeResponse) MarshalJSON() ([]byte, error) {
...
func (o SubscriptionOfferCodeOneTimeUseCodeResponse) ToMap() (map[string]interface{}, error) {
...
type NullableSubscriptionOfferCodeOneTimeUseCodeResponse struct {
	value *SubscriptionOfferCodeOneTimeUseCodeResponse
	isSet bool
}

func (v NullableSubscriptionOfferCodeOneTimeUseCodeResponse) Get() *SubscriptionOfferCodeOneTimeUseCodeResponse {
	return v.value
}

func (v *NullableSubscriptionOfferCodeOneTimeUseCodeResponse) Set(val *SubscriptionOfferCodeOneTimeUseCodeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSubscriptionOfferCodeOneTimeUseCodeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSubscriptionOfferCodeOneTimeUseCodeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubscriptionOfferCodeOneTimeUseCodeResponse(val *SubscriptionOfferCodeOneTimeUseCodeResponse) *NullableSubscriptionOfferCodeOneTimeUseCodeResponse {
	return &NullableSubscriptionOfferCodeOneTimeUseCodeResponse{value: val, isSet: true}
}

func (v NullableSubscriptionOfferCodeOneTimeUseCodeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubscriptionOfferCodeOneTimeUseCodeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
