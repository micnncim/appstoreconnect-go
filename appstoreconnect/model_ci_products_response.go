...
// checks if the CiProductsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CiProductsResponse{}

// CiProductsResponse struct for CiProductsResponse
...
func (o CiProductsResponse) MarshalJSON() ([]byte, error) {
...
func (o CiProductsResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCiProductsResponse struct {
	value *CiProductsResponse
	isSet bool
}

func (v NullableCiProductsResponse) Get() *CiProductsResponse {
	return v.value
}

func (v *NullableCiProductsResponse) Set(val *CiProductsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCiProductsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCiProductsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCiProductsResponse(val *CiProductsResponse) *NullableCiProductsResponse {
	return &NullableCiProductsResponse{value: val, isSet: true}
}

func (v NullableCiProductsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCiProductsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
