...
// checks if the ProfilesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProfilesResponse{}
...
func (o ProfilesResponse) ToMap() (map[string]interface{}, error) {
