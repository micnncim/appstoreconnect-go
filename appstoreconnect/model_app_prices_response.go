...
// checks if the AppPricesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppPricesResponse{}
...
func (o AppPricesResponse) ToMap() (map[string]interface{}, error) {
