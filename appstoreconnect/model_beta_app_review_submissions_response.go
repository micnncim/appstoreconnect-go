...
// checks if the BetaAppReviewSubmissionsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BetaAppReviewSubmissionsResponse{}
...
func (o BetaAppReviewSubmissionsResponse) ToMap() (map[string]interface{}, error) {
