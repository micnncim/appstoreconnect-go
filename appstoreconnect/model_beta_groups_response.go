...
// checks if the BetaGroupsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BetaGroupsResponse{}
...
func (o BetaGroupsResponse) ToMap() (map[string]interface{}, error) {
