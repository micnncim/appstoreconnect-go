...
// checks if the PreReleaseVersionsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PreReleaseVersionsResponse{}
...
func (o PreReleaseVersionsResponse) ToMap() (map[string]interface{}, error) {
