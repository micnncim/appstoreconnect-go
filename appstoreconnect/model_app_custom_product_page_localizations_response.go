...
// checks if the AppCustomProductPageLocalizationsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppCustomProductPageLocalizationsResponse{}

// AppCustomProductPageLocalizationsResponse struct for AppCustomProductPageLocalizationsResponse
...
func NewAppCustomProductPageLocalizationsResponse(data []AppCustomProductPageLocalization, links PagedDocumentLinks) *AppCustomProductPageLocalizationsResponse {
	this := AppCustomProductPageLocalizationsResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o AppCustomProductPageLocalizationsResponse) MarshalJSON() ([]byte, error) {
...
func (o AppCustomProductPageLocalizationsResponse) ToMap() (map[string]interface{}, error) {
...
type NullableAppCustomProductPageLocalizationsResponse struct {
	value *AppCustomProductPageLocalizationsResponse
	isSet bool
}

func (v NullableAppCustomProductPageLocalizationsResponse) Get() *AppCustomProductPageLocalizationsResponse {
	return v.value
}

func (v *NullableAppCustomProductPageLocalizationsResponse) Set(val *AppCustomProductPageLocalizationsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppCustomProductPageLocalizationsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppCustomProductPageLocalizationsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppCustomProductPageLocalizationsResponse(val *AppCustomProductPageLocalizationsResponse) *NullableAppCustomProductPageLocalizationsResponse {
	return &NullableAppCustomProductPageLocalizationsResponse{value: val, isSet: true}
}

func (v NullableAppCustomProductPageLocalizationsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppCustomProductPageLocalizationsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
