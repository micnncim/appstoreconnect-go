...
// checks if the BundleIdCapabilitiesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BundleIdCapabilitiesResponse{}
...
func (o BundleIdCapabilitiesResponse) ToMap() (map[string]interface{}, error) {
