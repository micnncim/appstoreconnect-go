...
// checks if the GameCenterGroupsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GameCenterGroupsResponse{}

// GameCenterGroupsResponse struct for GameCenterGroupsResponse
...
func (o GameCenterGroupsResponse) MarshalJSON() ([]byte, error) {
...
func (o GameCenterGroupsResponse) ToMap() (map[string]interface{}, error) {
...
type NullableGameCenterGroupsResponse struct {
	value *GameCenterGroupsResponse
	isSet bool
}

func (v NullableGameCenterGroupsResponse) Get() *GameCenterGroupsResponse {
	return v.value
}

func (v *NullableGameCenterGroupsResponse) Set(val *GameCenterGroupsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGameCenterGroupsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGameCenterGroupsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGameCenterGroupsResponse(val *GameCenterGroupsResponse) *NullableGameCenterGroupsResponse {
	return &NullableGameCenterGroupsResponse{value: val, isSet: true}
}

func (v NullableGameCenterGroupsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGameCenterGroupsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
