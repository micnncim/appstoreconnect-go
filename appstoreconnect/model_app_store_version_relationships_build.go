...
// checks if the AppStoreVersionRelationshipsBuild type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppStoreVersionRelationshipsBuild{}
...
func (o AppStoreVersionRelationshipsBuild) ToMap() (map[string]interface{}, error) {
