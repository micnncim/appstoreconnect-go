...
// checks if the SubscriptionOfferCodePricesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionOfferCodePricesResponse{}

// SubscriptionOfferCodePricesResponse struct for SubscriptionOfferCodePricesResponse
type SubscriptionOfferCodePricesResponse struct {
	Data     []SubscriptionOfferCodePrice                       `json:"data"`
...
func NewSubscriptionOfferCodePricesResponse(data []SubscriptionOfferCodePrice, links PagedDocumentLinks) *SubscriptionOfferCodePricesResponse {
	this := SubscriptionOfferCodePricesResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o *SubscriptionOfferCodePricesResponse) GetData() []SubscriptionOfferCodePrice {
	if o == nil {
		var ret []SubscriptionOfferCodePrice
		return ret
	}
...
func (o SubscriptionOfferCodePricesResponse) MarshalJSON() ([]byte, error) {
...
func (o SubscriptionOfferCodePricesResponse) ToMap() (map[string]interface{}, error) {
...
type NullableSubscriptionOfferCodePricesResponse struct {
	value *SubscriptionOfferCodePricesResponse
	isSet bool
}

func (v NullableSubscriptionOfferCodePricesResponse) Get() *SubscriptionOfferCodePricesResponse {
	return v.value
}

func (v *NullableSubscriptionOfferCodePricesResponse) Set(val *SubscriptionOfferCodePricesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSubscriptionOfferCodePricesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSubscriptionOfferCodePricesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubscriptionOfferCodePricesResponse(val *SubscriptionOfferCodePricesResponse) *NullableSubscriptionOfferCodePricesResponse {
	return &NullableSubscriptionOfferCodePricesResponse{value: val, isSet: true}
}

func (v NullableSubscriptionOfferCodePricesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubscriptionOfferCodePricesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
