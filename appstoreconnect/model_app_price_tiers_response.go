...
// checks if the AppPriceTiersResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppPriceTiersResponse{}
...
func (o AppPriceTiersResponse) ToMap() (map[string]interface{}, error) {
