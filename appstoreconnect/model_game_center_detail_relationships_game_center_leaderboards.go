...
// checks if the GameCenterDetailRelationshipsGameCenterLeaderboards type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GameCenterDetailRelationshipsGameCenterLeaderboards{}

// GameCenterDetailRelationshipsGameCenterLeaderboards struct for GameCenterDetailRelationshipsGameCenterLeaderboards
type GameCenterDetailRelationshipsGameCenterLeaderboards struct {
...
func NewGameCenterDetailRelationshipsGameCenterLeaderboards() *GameCenterDetailRelationshipsGameCenterLeaderboards {
	this := GameCenterDetailRelationshipsGameCenterLeaderboards{}
	return &this
}
...
func (o GameCenterDetailRelationshipsGameCenterLeaderboards) MarshalJSON() ([]byte, error) {
...
func (o GameCenterDetailRelationshipsGameCenterLeaderboards) ToMap() (map[string]interface{}, error) {
...
type NullableGameCenterDetailRelationshipsGameCenterLeaderboards struct {
	value *GameCenterDetailRelationshipsGameCenterLeaderboards
	isSet bool
}

func (v NullableGameCenterDetailRelationshipsGameCenterLeaderboards) Get() *GameCenterDetailRelationshipsGameCenterLeaderboards {
	return v.value
}

func (v *NullableGameCenterDetailRelationshipsGameCenterLeaderboards) Set(val *GameCenterDetailRelationshipsGameCenterLeaderboards) {
	v.value = val
	v.isSet = true
}

func (v NullableGameCenterDetailRelationshipsGameCenterLeaderboards) IsSet() bool {
	return v.isSet
}

func (v *NullableGameCenterDetailRelationshipsGameCenterLeaderboards) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGameCenterDetailRelationshipsGameCenterLeaderboards(val *GameCenterDetailRelationshipsGameCenterLeaderboards) *NullableGameCenterDetailRelationshipsGameCenterLeaderboards {
	return &NullableGameCenterDetailRelationshipsGameCenterLeaderboards{value: val, isSet: true}
}

func (v NullableGameCenterDetailRelationshipsGameCenterLeaderboards) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGameCenterDetailRelationshipsGameCenterLeaderboards) UnmarshalJSON(src []byte) error {
	v.isSet = true
