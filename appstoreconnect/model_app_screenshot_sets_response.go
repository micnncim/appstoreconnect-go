...
// checks if the AppScreenshotSetsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppScreenshotSetsResponse{}
...
type AppScreenshotSetsResponse struct {
	...
	Included []AppScreenshotSetsResponseIncludedInner `json:"included,omitempty"`
...
func (o *AppScreenshotSetsResponse) GetIncluded() []AppScreenshotSetsResponseIncludedInner {
	if o == nil || IsNil(o.Included) {
		var ret []AppScreenshotSetsResponseIncludedInner
		return ret
	}
	return o.Included
}
...
// SetIncluded gets a reference to the given []AppScreenshotSetsResponseIncludedInner and assigns it to the Included field.
...
func (o AppScreenshotSetsResponse) ToMap() (map[string]interface{}, error) {
