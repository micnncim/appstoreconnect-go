...
// checks if the AppScreenshotSetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppScreenshotSetResponse{}
...
func (o AppScreenshotSetResponse) ToMap() (map[string]interface{}, error) {
