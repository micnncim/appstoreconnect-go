...
// checks if the AppEncryptionDeclarationsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppEncryptionDeclarationsResponse{}
...
func (o AppEncryptionDeclarationsResponse) ToMap() (map[string]interface{}, error) {
