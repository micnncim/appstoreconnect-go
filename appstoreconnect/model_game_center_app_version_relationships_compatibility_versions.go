...
type GameCenterAppVersionRelationshipsCompatibilityVersions struct {
	...
	Data  []GameCenterAppVersionRelationshipsCompatibilityVersionsDataInner `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []GameCenterAppVersionRelationshipsCompatibilityVersionsDataInner and assigns it to the Data field.
