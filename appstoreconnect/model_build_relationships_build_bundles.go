...
// checks if the BuildRelationshipsBuildBundles type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BuildRelationshipsBuildBundles{}

// BuildRelationshipsBuildBundles struct for BuildRelationshipsBuildBundles
type BuildRelationshipsBuildBundles struct {
	Links *AppAvailabilityV2RelationshipsTerritoryAvailabilitiesLinks          `json:"links,omitempty"`
	Meta  *PagingInformation                                                   `json:"meta,omitempty"`
	Data  []BetaAppClipInvocationCreateRequestDataRelationshipsBuildBundleData `json:"data,omitempty"`
}
...
func NewBuildRelationshipsBuildBundles() *BuildRelationshipsBuildBundles {
	this := BuildRelationshipsBuildBundles{}
	return &this
}
...
// SetData gets a reference to the given []BetaAppClipInvocationCreateRequestDataRelationshipsBuildBundleData and assigns it to the Data field.
func (o *BuildRelationshipsBuildBundles) SetData(v []BetaAppClipInvocationCreateRequestDataRelationshipsBuildBundleData) {
	o.Data = v
}

func (o BuildRelationshipsBuildBundles) MarshalJSON() ([]byte, error) {
...
func (o BuildRelationshipsBuildBundles) ToMap() (map[string]interface{}, error) {
...
type NullableBuildRelationshipsBuildBundles struct {
	value *BuildRelationshipsBuildBundles
	isSet bool
}

func (v NullableBuildRelationshipsBuildBundles) Get() *BuildRelationshipsBuildBundles {
	return v.value
}

func (v *NullableBuildRelationshipsBuildBundles) Set(val *BuildRelationshipsBuildBundles) {
	v.value = val
	v.isSet = true
}

func (v NullableBuildRelationshipsBuildBundles) IsSet() bool {
	return v.isSet
}

func (v *NullableBuildRelationshipsBuildBundles) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBuildRelationshipsBuildBundles(val *BuildRelationshipsBuildBundles) *NullableBuildRelationshipsBuildBundles {
	return &NullableBuildRelationshipsBuildBundles{value: val, isSet: true}
}

func (v NullableBuildRelationshipsBuildBundles) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBuildRelationshipsBuildBundles) UnmarshalJSON(src []byte) error {
	v.isSet = true
