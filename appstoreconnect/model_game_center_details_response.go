...
// checks if the GameCenterDetailsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GameCenterDetailsResponse{}

// GameCenterDetailsResponse struct for GameCenterDetailsResponse
...
func NewGameCenterDetailsResponse(data []GameCenterDetail, links PagedDocumentLinks) *GameCenterDetailsResponse {
	this := GameCenterDetailsResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o GameCenterDetailsResponse) MarshalJSON() ([]byte, error) {
...
func (o GameCenterDetailsResponse) ToMap() (map[string]interface{}, error) {
...
type NullableGameCenterDetailsResponse struct {
	value *GameCenterDetailsResponse
	isSet bool
}

func (v NullableGameCenterDetailsResponse) Get() *GameCenterDetailsResponse {
	return v.value
}

func (v *NullableGameCenterDetailsResponse) Set(val *GameCenterDetailsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGameCenterDetailsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGameCenterDetailsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGameCenterDetailsResponse(val *GameCenterDetailsResponse) *NullableGameCenterDetailsResponse {
	return &NullableGameCenterDetailsResponse{value: val, isSet: true}
}

func (v NullableGameCenterDetailsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGameCenterDetailsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
