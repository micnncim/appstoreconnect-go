...
// checks if the InAppPurchasesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InAppPurchasesResponse{}
...
func (o InAppPurchasesResponse) ToMap() (map[string]interface{}, error) {
