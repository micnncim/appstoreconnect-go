...
// checks if the AppScreenshotCreateRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppScreenshotCreateRequestData{}
...
func (o AppScreenshotCreateRequestData) ToMap() (map[string]interface{}, error) {
