...
// checks if the SubscriptionLocalizationsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionLocalizationsResponse{}

// SubscriptionLocalizationsResponse struct for SubscriptionLocalizationsResponse
...
func NewSubscriptionLocalizationsResponse(data []SubscriptionLocalization, links PagedDocumentLinks) *SubscriptionLocalizationsResponse {
	this := SubscriptionLocalizationsResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o *SubscriptionLocalizationsResponse) GetData() []SubscriptionLocalization {
	if o == nil {
		var ret []SubscriptionLocalization
		return ret
	}
...
func (o SubscriptionLocalizationsResponse) MarshalJSON() ([]byte, error) {
...
func (o SubscriptionLocalizationsResponse) ToMap() (map[string]interface{}, error) {
...
type NullableSubscriptionLocalizationsResponse struct {
	value *SubscriptionLocalizationsResponse
	isSet bool
}

func (v NullableSubscriptionLocalizationsResponse) Get() *SubscriptionLocalizationsResponse {
	return v.value
}

func (v *NullableSubscriptionLocalizationsResponse) Set(val *SubscriptionLocalizationsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSubscriptionLocalizationsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSubscriptionLocalizationsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubscriptionLocalizationsResponse(val *SubscriptionLocalizationsResponse) *NullableSubscriptionLocalizationsResponse {
	return &NullableSubscriptionLocalizationsResponse{value: val, isSet: true}
}

func (v NullableSubscriptionLocalizationsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubscriptionLocalizationsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
