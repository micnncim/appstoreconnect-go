...
// checks if the AppRelationshipsAppEncryptionDeclarations type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppRelationshipsAppEncryptionDeclarations{}

// AppRelationshipsAppEncryptionDeclarations struct for AppRelationshipsAppEncryptionDeclarations
type AppRelationshipsAppEncryptionDeclarations struct {
...
func NewAppRelationshipsAppEncryptionDeclarations() *AppRelationshipsAppEncryptionDeclarations {
	this := AppRelationshipsAppEncryptionDeclarations{}
	return &this
}
...
func (o AppRelationshipsAppEncryptionDeclarations) MarshalJSON() ([]byte, error) {
...
func (o AppRelationshipsAppEncryptionDeclarations) ToMap() (map[string]interface{}, error) {
...
type NullableAppRelationshipsAppEncryptionDeclarations struct {
	value *AppRelationshipsAppEncryptionDeclarations
	isSet bool
}

func (v NullableAppRelationshipsAppEncryptionDeclarations) Get() *AppRelationshipsAppEncryptionDeclarations {
	return v.value
}

func (v *NullableAppRelationshipsAppEncryptionDeclarations) Set(val *AppRelationshipsAppEncryptionDeclarations) {
	v.value = val
	v.isSet = true
}

func (v NullableAppRelationshipsAppEncryptionDeclarations) IsSet() bool {
	return v.isSet
}

func (v *NullableAppRelationshipsAppEncryptionDeclarations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppRelationshipsAppEncryptionDeclarations(val *AppRelationshipsAppEncryptionDeclarations) *NullableAppRelationshipsAppEncryptionDeclarations {
	return &NullableAppRelationshipsAppEncryptionDeclarations{value: val, isSet: true}
}

func (v NullableAppRelationshipsAppEncryptionDeclarations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppRelationshipsAppEncryptionDeclarations) UnmarshalJSON(src []byte) error {
	v.isSet = true
