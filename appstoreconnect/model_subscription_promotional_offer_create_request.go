...
// checks if the SubscriptionPromotionalOfferCreateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionPromotionalOfferCreateRequest{}

// SubscriptionPromotionalOfferCreateRequest struct for SubscriptionPromotionalOfferCreateRequest
type SubscriptionPromotionalOfferCreateRequest struct {
	Data     SubscriptionPromotionalOfferCreateRequestData   `json:"data"`
...
func NewSubscriptionPromotionalOfferCreateRequest(data SubscriptionPromotionalOfferCreateRequestData) *SubscriptionPromotionalOfferCreateRequest {
	this := SubscriptionPromotionalOfferCreateRequest{}
	this.Data = data
	return &this
}
...
func (o *SubscriptionPromotionalOfferCreateRequest) GetData() SubscriptionPromotionalOfferCreateRequestData {
	if o == nil {
		var ret SubscriptionPromotionalOfferCreateRequestData
		return ret
	}
...
func (o SubscriptionPromotionalOfferCreateRequest) MarshalJSON() ([]byte, error) {
...
func (o SubscriptionPromotionalOfferCreateRequest) ToMap() (map[string]interface{}, error) {
...
type NullableSubscriptionPromotionalOfferCreateRequest struct {
	value *SubscriptionPromotionalOfferCreateRequest
	isSet bool
}

func (v NullableSubscriptionPromotionalOfferCreateRequest) Get() *SubscriptionPromotionalOfferCreateRequest {
	return v.value
}

func (v *NullableSubscriptionPromotionalOfferCreateRequest) Set(val *SubscriptionPromotionalOfferCreateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSubscriptionPromotionalOfferCreateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSubscriptionPromotionalOfferCreateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubscriptionPromotionalOfferCreateRequest(val *SubscriptionPromotionalOfferCreateRequest) *NullableSubscriptionPromotionalOfferCreateRequest {
	return &NullableSubscriptionPromotionalOfferCreateRequest{value: val, isSet: true}
}

func (v NullableSubscriptionPromotionalOfferCreateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubscriptionPromotionalOfferCreateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
