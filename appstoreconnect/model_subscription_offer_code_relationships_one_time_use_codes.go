...
// checks if the SubscriptionOfferCodeRelationshipsOneTimeUseCodes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionOfferCodeRelationshipsOneTimeUseCodes{}

// SubscriptionOfferCodeRelationshipsOneTimeUseCodes struct for SubscriptionOfferCodeRelationshipsOneTimeUseCodes
type SubscriptionOfferCodeRelationshipsOneTimeUseCodes struct {
	Links *AppAvailabilityV2RelationshipsTerritoryAvailabilitiesLinks  `json:"links,omitempty"`
	Meta  *PagingInformation                                           `json:"meta,omitempty"`
	Data  []SubscriptionOfferCodeRelationshipsOneTimeUseCodesDataInner `json:"data,omitempty"`
}
...
func NewSubscriptionOfferCodeRelationshipsOneTimeUseCodes() *SubscriptionOfferCodeRelationshipsOneTimeUseCodes {
	this := SubscriptionOfferCodeRelationshipsOneTimeUseCodes{}
	return &this
}
...
func (o *SubscriptionOfferCodeRelationshipsOneTimeUseCodes) GetData() []SubscriptionOfferCodeRelationshipsOneTimeUseCodesDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []SubscriptionOfferCodeRelationshipsOneTimeUseCodesDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []SubscriptionOfferCodeRelationshipsOneTimeUseCodesDataInner and assigns it to the Data field.
...
func (o SubscriptionOfferCodeRelationshipsOneTimeUseCodes) MarshalJSON() ([]byte, error) {
...
func (o SubscriptionOfferCodeRelationshipsOneTimeUseCodes) ToMap() (map[string]interface{}, error) {
...
type NullableSubscriptionOfferCodeRelationshipsOneTimeUseCodes struct {
	value *SubscriptionOfferCodeRelationshipsOneTimeUseCodes
	isSet bool
}

func (v NullableSubscriptionOfferCodeRelationshipsOneTimeUseCodes) Get() *SubscriptionOfferCodeRelationshipsOneTimeUseCodes {
	return v.value
}

func (v *NullableSubscriptionOfferCodeRelationshipsOneTimeUseCodes) Set(val *SubscriptionOfferCodeRelationshipsOneTimeUseCodes) {
	v.value = val
	v.isSet = true
}

func (v NullableSubscriptionOfferCodeRelationshipsOneTimeUseCodes) IsSet() bool {
	return v.isSet
}

func (v *NullableSubscriptionOfferCodeRelationshipsOneTimeUseCodes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubscriptionOfferCodeRelationshipsOneTimeUseCodes(val *SubscriptionOfferCodeRelationshipsOneTimeUseCodes) *NullableSubscriptionOfferCodeRelationshipsOneTimeUseCodes {
	return &NullableSubscriptionOfferCodeRelationshipsOneTimeUseCodes{value: val, isSet: true}
}

func (v NullableSubscriptionOfferCodeRelationshipsOneTimeUseCodes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubscriptionOfferCodeRelationshipsOneTimeUseCodes) UnmarshalJSON(src []byte) error {
	v.isSet = true
