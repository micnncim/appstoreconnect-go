...
// checks if the BuildsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BuildsResponse{}
...
func (o BuildsResponse) ToMap() (map[string]interface{}, error) {
