...
// checks if the CapabilitySetting type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CapabilitySetting{}
...
func (o *CapabilitySetting) GetAllowedInstances() string {
	if o == nil || IsNil(o.AllowedInstances) {
		var ret string
		return ret
	}
...
func (o CapabilitySetting) ToMap() (map[string]interface{}, error) {
