...
// checks if the ScmPullRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScmPullRequest{}

// ScmPullRequest struct for ScmPullRequest
...
func (o *ScmPullRequest) GetAttributes() ScmPullRequestAttributes {
	if o == nil || IsNil(o.Attributes) {
		var ret ScmPullRequestAttributes
		return ret
	}
	return *o.Attributes
}
...
// SetAttributes gets a reference to the given ScmPullRequestAttributes and assigns it to the Attributes field.
...
func (o ScmPullRequest) MarshalJSON() ([]byte, error) {
...
func (o ScmPullRequest) ToMap() (map[string]interface{}, error) {
...
type NullableScmPullRequest struct {
	value *ScmPullRequest
	isSet bool
}

func (v NullableScmPullRequest) Get() *ScmPullRequest {
	return v.value
}

func (v *NullableScmPullRequest) Set(val *ScmPullRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableScmPullRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableScmPullRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScmPullRequest(val *ScmPullRequest) *NullableScmPullRequest {
	return &NullableScmPullRequest{value: val, isSet: true}
}

func (v NullableScmPullRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScmPullRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
